...
class LaravelLogFileAdapter implements LogSourceAdapter
{
    ...
    /**
     * @param array<int, string> $allowlist Absolute paths that are permitted. Relative paths,
     *                                      symlinks resolving outside the list, and anything
     *                                      missing from the list is rejected.
     */
